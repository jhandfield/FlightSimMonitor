...
namespace Handfield.FlightSimMonitor.Console
{
    class FSMon
    {
        ...
        private static void UpdateDisplay(FlightSimMonitor.DataReceivedEventArgs args)
        {
            ...
            UpdateFieldValue(12, 3, 4, $"{args.Heading}");                                           // Heading
            //UpdateFieldValue(12, 3, 4, $"N/A");                                           // Heading
            UpdateFieldValue(12, 4, 6, $"{args.IndicatedAirspeed.ToString("0")}kts");                               // Indicated Speed
            UpdateFieldValue(12, 5, 6, "0kts");                                                                     // True Airspeed
            UpdateFieldValue(12, 6, 6, $"{args.GPSGroundSpeed.ToString("0")}kts");                                  // Groundspeed
            UpdateFieldValue(12, 7, 8, $"{args.VerticalSpeedPerSecond.ToString("0")}fpm");                                   // Vertical Speed

            // Column 2
            UpdateFieldValue(41, 1, 14, "On");
            UpdateFieldValue(41, 2, 14, "Running");
            UpdateFieldValue(41, 3, 14, "N/A");
            UpdateFieldValue(41, 4, 14, "N/A");
